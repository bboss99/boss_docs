...
This is alternate way of creating blender addons and scripts. This is open-source, object oriented, easy and dynamic way
of creating UI and HUDs.

You can create addon just fine, inheriting from :ref:`BOSS_OT_base_ui<boss_ot_base_ui_title>` for dedicated tasks and
install it like a
...
..  toctree::
    ...
    getting_started/ui_creator
    getting_started/Launchers
    getting_started/Comparisons
